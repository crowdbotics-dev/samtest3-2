"""
Django settings for samtest3_2 project.
...
WSGI_APPLICATION = 'samtest3_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtest3_2 API",
    "DESCRIPTION": "API documentation for samtest3_2 App",
    "VERSION": "v1",
}
